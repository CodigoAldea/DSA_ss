...
class LinkedList : 
    ...
    def print_list(self) : 
        current = self.head # pointing the current to the head
        while current : 
            print(current.data, end = " -> ") # printing the data of the current node
            current = current.next # pointing the current to the next node
...
print("Before inserting in the middle:")
linked_list.print_list() # printing the linked list before inserting in the middle
linked_list.insert_middle(25, 1) # inserting 25 at position 1
print("After inserting in the middle:")
linked_list.print_list() # printing the linked list after inserting in the middle